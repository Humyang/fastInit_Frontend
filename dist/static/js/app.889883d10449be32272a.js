...
exports.default = {
  ...
  methods: {
    codeBlockDragStart: function codeBlockDragStart(parent_index, current_index, event) {
  ...
  mounted: function mounted() {
    ...
    this.editor.on("drop", function (event, e2) {
      var value = self.MODULE.fileBlock[self.project.parent_index].blockList[self.project.current_index].value;
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "blockList_wrap"
  }, _vm._l((_vm.MODULE.fileBlock), function(item, parent_index) {
    return _c('div', {
      staticClass: "cell",
      attrs: {
        "id": 'cell' + parent_index
      }
    }, [_c('p', {
      staticClass: "head"
    }, [_vm._v(_vm._s(item.name))]), _vm._v(" "), _vm._l((item.blockList), function(block, current_index) {
      return _c('code', {
        ...
        on: {
          "dragstart": function($event) {
            _vm.codeBlockDragStart(parent_index, current_index, $event)
          }
        }
      }, [_vm._v("\n                  " + _vm._s(block.value) + "\n                ")])
    })], 2)
  }))]), _vm._v(" "), _vm._m(0)]), _vm._v(" "), _c('div', {
    staticClass: "preConfig_wrap"
  }, [_c('div', {
  ...
  }, [_vm._v("保存项目")])]), _vm._v(" "), _vm._m(1), _vm._v(" "), _c('ul', _vm._l((_vm.configList.list), function(item) {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.block_write($event)
      }
    }
  }, [_vm._v("写入")]), _vm._v(" "), _c('a', {
    staticClass: "btn black",
    attrs: {
      "href": "#"
    },
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.block_split($event)
      }
    }
  }, [_vm._v("分割")])]), _vm._v(" "), _c('div', {
    staticClass: "textarea_wrap"
  }, _vm._l((_vm.blockCode.blockInput), function(item, index) {
    return _c('textarea', {
      directives: [{
        name: "model",
        rawName: "v-model",
      ...
      on: {
        "click": function($event) {
          _vm.block_textarea_select(index, $event)
        },
        "input": function($event) {
          if ($event.target.composing) { return; }
  ...
  }, _vm._l((_vm.blockCode.cacheList), function(item, index) {
    return _c('div', {
      staticClass: "codeblock",
      attrs: {
        "id": "codeblock1",
      ...
      on: {
        "dragstart": function($event) {
          _vm.codeBlockDragStart(index, $event)
        }
      }
    }, [_vm._v("\n        " + _vm._s(item.value) + "\n      ")])
  }))]), _vm._v(" "), _c('div', {
    ...
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.fileBlock.visibleAddFileBlock = true
      }
    }
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.fileBlock.visibleAddFileBlock),
      expression: "fileBlock.visibleAddFileBlock"
    }],
    staticClass: "add_wrap"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.fileBlock.newFileBlockName),
      expression: "fileBlock.newFileBlockName"
    }],
    attrs: {
      "placeholder": "输入文章标题",
      "type": "",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.fileBlock.newFileBlockName = $event.target.value
      }
    }
  }), _vm._v(" "), _c('a', {
    staticClass: "btn btn_ok",
    ...
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.fileBlock.visibleAddFileBlock = false
      }
    }
  }, [_vm._v("取消")])]), _vm._v(" "), _vm._l((_vm.fileBlock.list), function(item, index) {
    return _c('div', {
      staticClass: "cell",
      class: {
        dropover: _vm.fileBlock.dropOverIndex === index
      },
      attrs: {
        "id": 'cell' + index
      },
      on: {
        "dragover": function($event) {
          $event.preventDefault();
          _vm.fileBlockOnDropOver(index)
        },
        "dragleave": function($event) {
          $event.preventDefault();
          _vm.fileBlockOnDropOut($event)
        },
        "drop": function($event) {
          _vm.fileBlockOnDrop(index, $event)
        }
      }
    }, [_c('p', {
      staticClass: "head"
    }, [_vm._v(_vm._s(item.name))]), _vm._v(" "), _vm._l((item.blockList), function(block, index) {
      return _c('code', {
        staticClass: "codeblock"
      }, [_vm._v(_vm._s(block.value))])
    })], 2)
  })], 2), _vm._v("\n  " + _vm._s(_vm.saveData) + "\n")])
}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
...
exports.default = {
  ...
  watch: {
    "blockCode.blockInput": { handler: function handler() {
  ...
  methods: {
    saveData: function saveData() {
      var blockInput = (0, _stringify2.default)(this.blockCode.blockInput);

      var cacheList = (0, _stringify2.default)(this.blockCode.cacheList);

      var fileBlock = (0, _stringify2.default)(this.fileBlock.list);
    ...
    block_write: function block_write() {
      var newObj = [];
    ...
    block_split: function block_split() {
      ...
      var valueArray = [].concat((0, _toConsumableArray3.default)(this.blockCode.blockInput));
      ...
      this.blockCode.blockInput = [].concat((0, _toConsumableArray3.default)(valueArray));
    },
  ...
  mounted: function mounted() {
    ...
    this.Delay = new _Delay2.default(500, function (obj) {
...
//# sourceMappingURL=app.889883d10449be32272a.js.map